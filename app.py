...
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://root:password@localhost/proyecto"
...
@app.route("/producto", methods=["POST"])  # Endpoint para crear un producto
def create_producto():
    """
...
@app.route("/producto/<id>", methods=["PUT"])  # Endpoint para actualizar un producto
